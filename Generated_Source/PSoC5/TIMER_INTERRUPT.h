...
#define TIMER_INTERRUPT_INTC_VECTOR            ((reg32 *) TIMER_INTERRUPT__INTC_VECT)
...
#define TIMER_INTERRUPT_INTC_SET_EN            ((reg32 *) TIMER_INTERRUPT__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the TIMER_INTERRUPT interrupt. */
#define TIMER_INTERRUPT_INTC_CLR_EN            ((reg32 *) TIMER_INTERRUPT__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the TIMER_INTERRUPT interrupt state to pending. */
#define TIMER_INTERRUPT_INTC_SET_PD            ((reg32 *) TIMER_INTERRUPT__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the TIMER_INTERRUPT interrupt. */
#define TIMER_INTERRUPT_INTC_CLR_PD            ((reg32 *) TIMER_INTERRUPT__INTC_CLR_PD_REG)
