...
*
* \funcusage
*  \snippet TX_PIN_SUT.c usage_TX_PIN_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet TX_PIN_SUT.c usage_TX_PIN_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet TX_PIN_SUT.c usage_TX_PIN_Read  
*******************************************************************************/
...
* preferred TX_PIN_Read() API because the 
* TX_PIN_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet TX_PIN_SUT.c usage_TX_PIN_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: TX_PIN_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use TX_PIN_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - TX_PIN_0_INTR       (First pin in the list)
    *  - TX_PIN_1_INTR       (Second pin in the list)
    *  - ...
    *  - TX_PIN_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet TX_PIN_SUT.c usage_TX_PIN_SetInterruptMode
    *******************************************************************************/
    void TX_PIN_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & TX_PIN_0_INTR) != 0u) 
		{ 
			 TX_PIN_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet TX_PIN_SUT.c usage_TX_PIN_ClearInterrupt
    *******************************************************************************/
