// ======================================================================
// network.v generated from TopDesign.cysch
// 02/09/2018 at 16:39
...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=23999, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=32, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_70, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TX_TIMER, CY_INSTANCE_SHORT_NAME=TX_TIMER, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=TX_TIMER, )
...
module top ;
	...
	wire [0:0] tmpOE__IDLE_PIN_net;
	wire [0:0] tmpFB_0__IDLE_PIN_net;
	wire [0:0] tmpIO_0__IDLE_PIN_net;
	wire [0:0] tmpINTERRUPT_0__IDLE_PIN_net;
	electrical [0:0] tmpSIOVREF__IDLE_PIN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		IDLE_PIN
		 (.oe(tmpOE__IDLE_PIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IDLE_PIN_net[0:0]}),
		  .io({tmpIO_0__IDLE_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__IDLE_PIN_net),
		  .interrupt({tmpINTERRUPT_0__IDLE_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IDLE_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUSY_PIN_net;
	wire [0:0] tmpFB_0__BUSY_PIN_net;
	wire [0:0] tmpIO_0__BUSY_PIN_net;
	wire [0:0] tmpINTERRUPT_0__BUSY_PIN_net;
	electrical [0:0] tmpSIOVREF__BUSY_PIN_net;

	cy_psoc3_pins_v1_10
		#(.id("672339b6-3029-469c-ac6a-56dacde88565"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUSY_PIN
		 (.oe(tmpOE__BUSY_PIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUSY_PIN_net[0:0]}),
		  .io({tmpIO_0__BUSY_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__BUSY_PIN_net),
		  .interrupt({tmpINTERRUPT_0__BUSY_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUSY_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__COLLISION_PIN_net;
	wire [0:0] tmpFB_0__COLLISION_PIN_net;
	wire [0:0] tmpIO_0__COLLISION_PIN_net;
	wire [0:0] tmpINTERRUPT_0__COLLISION_PIN_net;
	electrical [0:0] tmpSIOVREF__COLLISION_PIN_net;

	cy_psoc3_pins_v1_10
		#(.id("9beb82cc-2560-49ac-a9a9-79bf546661e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		COLLISION_PIN
		 (.oe(tmpOE__COLLISION_PIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__COLLISION_PIN_net[0:0]}),
		  .io({tmpIO_0__COLLISION_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__COLLISION_PIN_net),
		  .interrupt({tmpINTERRUPT_0__COLLISION_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__COLLISION_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("4873e435-e128-4370-8b2b-15854723b9b4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("63abcd26-6a57-4b1a-bffd-a4b9e2ccac1a"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
    ...
    Timer_v2_70_2 TX_TIMER (
        ...
        .tc(Net_177),
        .clock(Net_169));
    defparam TX_TIMER.CaptureCount = 2;
    defparam TX_TIMER.CaptureCounterEnabled = 0;
    defparam TX_TIMER.DeviceFamily = "PSoC5";
    defparam TX_TIMER.InterruptOnCapture = 0;
    defparam TX_TIMER.InterruptOnTC = 1;
    defparam TX_TIMER.Resolution = 32;
    defparam TX_TIMER.SiliconRevision = "0";
